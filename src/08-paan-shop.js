...
export function updatePrices(menu, increase) {
  if (typeof menu !== "object" || typeof increase !== "number" || Array.isArray(menu)  || menu == null) {
    return {};
  }

  
    const newArray = Object.entries(menu).map(([key, value]) => {
...
export function mergeDailySpecials(regularMenu, specialsMenu) {
  ...
  const newMergeObject = {...regularMenu, ...specialsMenu}
